import 'package:food_app/models/soup_model.dart';
import 'package:get/get.dart';
//

class SoupController extends GetxController {
  List<SoupModel> soups = [
    SoupModel(
      id: "1",
      img: "assets/images/s1.png",
      title: "japanese Ramen Soup with noodles and mushrooms",
    ...
    SoupModel(
      id: "2",
      img: "assets/images/s1.png",
      title: " Ramen Soup with noodles and mushrooms",
    ...
    SoupModel(
      id: "3",
      img: "assets/images/s1.png",
      title: "Soup with noodles and mushrooms",
  ...
  void addQ(int index) {
    if (soups[index].quantity < 9 && soups[index].quantity >= 0) {
      soups[index].quantity++;
    } else {
  ...
  void removeQ(int index) {
    if (soups[index].quantity > 1 && soups[index].quantity <= 9) {
      soups[index].quantity--;
    } else {
